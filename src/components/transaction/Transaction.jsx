...
import "../../assets/styles/transaction/transaction.scss";
      ...
      <div className="transaction">
        <div className="containers">
          <div className="transaction_items">
            <div className="transaction_items_hero">
            ...
            <div className="transaction_items_text">
              <p>
                ...
                molestiae consequatur, vel illum qui dolorem eum fugiat quo
                voluptas nulla pariatur. exercitationem ullam corporis suscipit
